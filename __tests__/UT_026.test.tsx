 ...
 * UT_026: Report data renders with summary statistics
 */
...
describe('UT_026: Report data renders with summary statistics', () => {
  ...
  test('Step 2: Shows Tasks by Priority section', () => {
    const { getByText } = render(<AnalyticsScreen navigation={nav} route={{} as any} />);
