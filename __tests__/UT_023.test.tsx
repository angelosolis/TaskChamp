 ...
 * UT_023: Multiple completed tasks exist - Display weekly completion graphs
 */
...
describe('UT_023: Multiple completed tasks exist - Display weekly completion graphs', () => {
  ...
  test('Step 2: Shows "This week" label', () => {
    const { getByText } = render(<AnalyticsScreen navigation={nav} route={{} as any} />);
